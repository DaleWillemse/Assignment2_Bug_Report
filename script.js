...
const CreateTicketElement = ({ TicketNumber, TicketTitle, TicketAuthor, TicketDescription, TicketType, TicketStatus, TicketDateIssued, TicketDateETACompleted, TicketDateCompleted }) => {
  ...
  editBtn.innerHTML = "<img src='edit.png' alt='edit' width='20' height='20'>";
...
//   Tickets[i].TicketAuthor,
//   Tickets[i].TicketType,
//   Tickets[i].TicketStatus,
//   Tickets[i].TicketDateETACompleted,
//   Tickets[i].TicketDateCompleted,
  
//  console.log(Tickets[0].TicketTitle);
// }
